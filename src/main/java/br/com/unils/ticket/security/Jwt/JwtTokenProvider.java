...
public class JwtTokenProvider {
	...
	public TokenVO createAccessToken(String username, List<String> roles, String nomeFuncionario, Long codFuncionario) {
		Date now = new Date();
		Date validity = new Date(now.getTime() + validityInMilliseconds);
		var accessToken = getAccessToken(username, roles, now, validity);
		var refreshToken = getRefreshToken(username, roles, now);
		return new TokenVO(username, true, now, validity.toString(), accessToken, refreshToken, nomeFuncionario, codFuncionario, roles);
	}
	...
	public TokenVO refreshToken(String refreshToken) {
		...
		return createAccessToken(username, roles, null, null);
	}
